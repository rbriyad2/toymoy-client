...
const AddAToy =(event)=>{
    ...
    const colors = color.value;
        ...
        const toydetails ={ name, price, weight, height, category, type, company, meterial, date, gender, model, stock, colors, description, image, email}
 

        fetch('https://toymoy-server-szgpselfd-rbriyad2gmailcoms-projects.vercel.app/toys', {
            method: 'POST',
            headers:{
    ...
    return (
      ...
      <div className="container mx-auto">
        <div className="toyadd  px-20 pt-12 pb-40 rounded-lg">
          <form onSubmit={AddAToy} className="text-center">
            <h2 className="text-2xl font-bold text-center mb-8">
              Add A Toy
            </h2>
            <div className='w-full flex justify-evenly mb-5'>
                <label htmlFor="name">Toy Name: </label>
                <input placeholder='Toy Name' name='name' className='px-4 py-2 w-10/12 ml-2 rounded' type="text" />
            </div>
            <div className="flex">
                <div className='w-1/3'>
                    <div className="w-full mb-4 flex justify-end">
                        <label htmlFor="price">Price:</label>
                        <input placeholder='Price' name='price' className='px-4 py-2 rounded w-9/12 ml-3' type="number" />
                    </div>
                    <div className="w-full mb-4 flex justify-end">
                        <label htmlFor="weight">Weight: </label>
                        <input placeholder='Weight' name='weight' className='px-4 py-2 rounded w-9/12 ml-3' type="text" />
                    </div>
                    <div className="w-full mb-4 flex justify-end">
                        <label htmlFor="height">Height:</label>
                        <input placeholder='Height' name='height' className='px-4 py-2 rounded w-9/12 ml-3' type="text" />
                    </div>
                    <div className="w-full mb-4 flex justify-end">
                ...
                <div className='w-1/3'>
                    ...
                    <div className="w-full mb-4 flex justify-end">
                        ...
                        <input placeholder='Toy type' className='px-4 py-2 rounded w-9/12 ml-3' name='type' type="text" />
                    </div>
                    <div className="w-full mb-4 flex justify-end">
                        <label htmlFor="company">Company: </label>
                        <input placeholder='Company Name' name='company' className='px-4 py-2 rounded w-9/12 ml-3' type="text" />
                    </div>
                    <div className="w-full mb-4 flex justify-end">
                        <label htmlFor="meterial">Material: </label>
                        <input placeholder='Material Type' name='meterial' className='px-4 py-2 rounded w-9/12 ml-3' type="text" />
                    </div>
                </div>
                <div className='w-1/3'>
                    <div className="w-full mb-4 flex justify-end">
                    ...
                    <div className="w-full mb-4 flex justify-end">
                        ...
                        <input placeholder='Model Number' name='model' className='px-4 py-2 rounded w-9/12 ml-3' type="text" />
                    </div>
                    <div className=" w-full mb-4 flex justify-end">
                        <label htmlFor="stock">Stock: </label>
                        <select name='stock' className=" w-9/12 px-4 py-2 rounded ml-3">
            ...
            <div className="loginbutton text-center">
              <input value='Add'  className="cursor-pointer loginbtn px-20 text-xl font-semibold" type="submit"/>
            </div>
          </form>
